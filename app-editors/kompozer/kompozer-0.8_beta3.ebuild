...
LANGS="ca da de en-US eo es-ES fi fr hsb hu it ja nl pl pt-PT ru zh-CN zh-TW"
# manque sur serveur : cs sl
NOSHORTLANGS="es-ES pt-PT xh-CN zh-TW"

DICTS="bg ca cs da de dsb en-GB en-US eo es-ES fi fr hsb hu it nl pl pt-BR pt-PT ru sl uk"
